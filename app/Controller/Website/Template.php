 ...
 * Template
 *
 * Provides features related to the Website template.
 */
class Template extends App
{
	 ...
	 * Get language
     *
     * Retrieve the available application languages.
	 */
	public function getLanguage(): array
	{
        return (new \Model\Core\Language())->getActive();
    }
    ...
    public function templateUrl(): object
    {
        ...
        $languageRoute = $moduleModel->getByRoute('Website/Language');
        ...
        return (object) [
            ...
            'language' => $languageRoute ? APP_URL . $languageRoute->url : '',
        ];
    }
