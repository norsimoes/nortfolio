...
$dataTables->setHeaders(
    ...
    [$i18n['DataTables'][4]],
    [$i18n['DataTables'][5]],
    [$i18n['DataTables'][6], 'class="text-center" data-col-class="text-center" data-sort-column="DESC"'],
...
<!-- Activation modal -->
<div id="j-activation-modal" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
    <form method="post" action="" class="modal-dialog" role="form" style="width: 600px">
        <div class="modal-content" style="min-height: 30px">
            <div id="j-activation-wrapper"></div>
        </div>
    </form>
</div>
