...
if ($data['role-id'] == 1) {
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" name="call-sign" value="' . $translationData->call_sign . '" required>
    </div>
    ';
    ...
    $callSignHtml = '
    <input type="hidden" name="call-sign" value="' . $translationData->call_sign . '">
    ';
}
...
foreach ($translationData->translations as $language) {
    ...
    $valueHtml .= '
    <div class="mb-3">
        <label title="' . $i18n['Formulary'][4] . ' ' . $language->iso2 . '">' . strtolower($i18n['Formulary'][3]) . ' ' . $language->iso2 . '</label>
