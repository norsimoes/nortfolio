...
class Dashboard extends App
{
    ...
    protected array $_moduleList = [
        'Administration/Translation' => 'Administration/Translation/Manage'
    ];
    ...
    public function getModuleData(): array
    {
        ...
        $routeArr = [
            ...
            'module' => 'Administration/Translation',
            'manage' => 'Administration/Translation/Manage',
            'add' => 'Administration/Translation/Add',
            'edit' => 'Administration/Translation/Edit',
            'delete' => 'Administration/Translation/Delete',
            'clone' => 'Administration/Translation/Copy',
            'group' => 'Administration/Translation/Group/Manage',
            'item' => 'Administration/Translation/Item/Manage',
            'copy' => 'Administration/Translation/Copy',
        ];
