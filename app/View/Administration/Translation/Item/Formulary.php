...
foreach ($itemData->translations as $language) {

    $valueHtml .= '
    <div class="mb-3">
        <label title="' . $i18n['Formulary'][7] . ' ' . $language->iso2 . '">' . strtolower($i18n['Formulary'][3]) . ' ' . $language->iso2 . '</label>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-6">
                                ...
                                <!-- Array key -->
                                <input type="hidden" name="array-key" value="<?= $itemData->array_key ?>">
