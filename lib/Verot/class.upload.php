    ...
    function process($server_path = null) {
        ...
        if ($this->processed) {
            ...
            if ($this->no_script) {
                ...
                if ((((substr($this->file_src_mime, 0, 5) == 'text/' && $this->file_src_mime != 'text/rtf') || strpos($this->file_src_mime, 'javascript') !== false) && (substr($file_src_name, -4) != '.txt') && (substr($file_src_name, -5) != '.json'))
