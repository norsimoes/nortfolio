...
class Dashboard extends App
{
    ...
    protected array $_moduleList = [
        'Administration/Blank' => 'Administration/Blank/Manage'
    ];
    ...
    public function getModuleData(): array
    {
        ...
        $routeArr = [
            ...
            'module' => 'Administration/Blank',
            'manage' => 'Administration/Blank/Manage',
            'add' => 'Administration/Blank/Add',
            'edit' => 'Administration/Blank/Edit',
            'delete' => 'Administration/Blank/Delete',
            'sort' => 'Administration/Blank/Sort',
        ];
