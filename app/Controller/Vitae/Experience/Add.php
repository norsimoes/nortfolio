...
class Add extends App
{
    ...
    public function index(): void
    {
        ...
        // Get data object
        $data['experience-data'] = $experienceModel->getDataObject();
    ...
    public function register(): void
    {
        ...
        $position = $experienceModel->getPosition();
        ...
        $experienceId = $experienceModel->add($nameArr, $startArr, $endArr, $companyArr, $locationArr, $descArr, $tech, $position);
