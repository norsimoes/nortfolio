...
class Dashboard extends App
{
    ...
    protected array $_moduleList = [
        'Administration/Language' => 'Administration/Language/Manage'
    ];
    ...
    public function getModuleData(): array
    {
        ...
        $routeArr = [
            ...
            'module' => 'Administration/Language',
            'manage' => 'Administration/Language/Manage',
            'add' => 'Administration/Language/Add',
            'edit' => 'Administration/Language/Edit',
