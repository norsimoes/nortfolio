...
$dataTables->setHeaders(
    [$i18n['DataTables'][1]],
    [$i18n['DataTables'][7], 'data-sort-column="ASC"'],
    [$i18n['DataTables'][8]],
    [$i18n['DataTables'][6], 'class="text-center" data-no-sort="" data-col-class="text-center"']
);
...
if (\Lib\Access::getInstance()->module($data['module-id-add'])) {
    ...
    $button->setAttr('title', $i18n['Manage'][14]);
...
$button->setAttr('class', 'header-button ml-2 cursor-pointer j-dt-reset');
...
<div class="container-fluid">
    ...
    <div class="card rounded-0 mb-2">
        <div class="card-header d-flex justify-content-between">
            <div>
                <div class="card-title"><?= strtolower($i18n['Manage'][7]) ?></div>
