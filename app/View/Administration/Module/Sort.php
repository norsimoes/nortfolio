 ...
 * ----------------------------------------------------------------------------
 */
$moduleArr = $data['module-data'] ?? [];

$moduleHtml = '';

if (is_array($moduleArr) && count($moduleArr) > 0) {

    foreach ($moduleArr as $module) {

        $moduleHtml .= '
        <div id="item-' . $module->module_id . '" class="j-sort-tile sort-row">
            ...
            <div class="row-content">
                ...
                <div class="ms-2">
                    <span class="fa fa-fw ' . $module->icon . ' me-2"></span>' . $module->name . '
                </div>
            </div>
