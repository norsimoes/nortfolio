...
class Add extends App
{
    ...
    public function index(): void
    {
        ...
        // Get data object
        $data['skill-data'] = $skillModel->getDataObject();
    ...
    public function register(): void
    {
        ...
        $position = $skillModel->getPosition();
        ...
        $icon = $file->processFile('icon', 'skill/');

        // Add skill record
        $skillId = $skillModel->add($nameArr, $overrideArr, $type, $value, $icon, $position);
